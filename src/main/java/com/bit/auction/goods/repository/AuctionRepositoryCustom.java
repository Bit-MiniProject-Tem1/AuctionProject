...
public interface AuctionRepositoryCustom {
    Page<Auction> searchAll(Pageable pageable, Long categoryId, List<Long> subCategoryIdList, String sortOption, List<String> targetList, List<Character> statusList);
